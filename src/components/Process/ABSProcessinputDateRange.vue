  ...
  <span>
    <b-row v-show="prop.cVisible">
      ...
      <b-col>
        ...
        <span v-show="errors.has(prop.cParentForm + '.' + prop.cName + 'From')"
          class="error-span">{{ errors.first(prop.cParentForm + '.' + prop.cName + 'From') }}
        </span>

        <!-- <label v-show="inputStatus=='view'" class="lbl-value-view-form">{{valueLabelFrom}}</label> -->
        <datepicker
      ...
      <b-col>
        ...
        <span v-show="errors.has(prop.cParentForm + '.' + prop.cName + 'To')"
          class="error-span">{{ errors.first(prop.cParentForm + '.' + prop.cName + 'To') }}
        </span>

        <!-- <label v-show="inputStatus=='view'" class="lbl-value-view-form">{{valueLabelTo}}</label> -->
        <!-- {{prop.cFormat}} -->
          <!-- v-validate="prop.cValidate + '|after:' + prop.cName + 'From'" -->
          <!-- v-validate="prop.cValidate + '|invalidDateRange:$' + prop.cName + 'From'" -->
        <datepicker
          v-validate="prop.cValidate + '|invalidDateRange:' + valueFrom"
          placeholder="Select Date"
          type="date"
          v-bind:name="prop.cName + 'To'"
          v-bind:data-vv-as="prop.cLabel + ' To'"
