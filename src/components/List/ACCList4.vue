  ...
  <div class="card">
    <div class="card__title" style="padding-bottom: 5px !important;">
      <b-row>
        ...
        <b-col style="text-align: right;" :md="hasSlot(`ToolbarTable`) ? '3' : ''" :offset="hasSlot(`ToolbarTable`) ? '' : '5'">
          <template>
        ...
        <b-col style="max-width:fit-content !important;" class="col-right">
          ...
          <span v-show="!(!urlAdd || urlAdd == '' || urlAdd == undefined || urlAdd == null)">
            <ABSButton
              :text="(!ButtonAddText || ButtonAddText == '' || ButtonAddText == undefined || ButtonAddText == null) ? 'Add' : ButtonAddText"
              classButton="button button--back"
              classIcon="icon-style-1"
              @click="onAddNewClick"
            />
        ...
        for (var i = 0; i < str_array.length; i++) {
          ...
          if (this.languageStatus) {
            ...
            var listReplace = [
              ...
              {
                key: "Row Id",
                value: this.ActionLabel && this.ActionLabel !== "" ? this.ActionLabel : "Action"
              },
              {
                key: "Ftl",
                value: "FTL"
