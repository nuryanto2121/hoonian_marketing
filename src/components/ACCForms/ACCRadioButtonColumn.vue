    ...
    <template>
      <b-row>
          <b-col :offset="prop.cLabelSize">
            ...
            <template v-for="(option, index) in prop.cRadioOptions">
              <template v-if="index % 3 == 2">
                <b-form-radio class="custom-control-inline" :value="option.value" :key="option.text">
                  {{ option.text }} {{ index % 3 == 2 }}
                </b-form-radio>
              </template>
              <template v-else>
                <b-form-radio class="custom-control-inline-2" :value="option.value" :key="option.text">
                  {{ option.text }} {{ index % 3 == 2 }}
                </b-form-radio>
              </template>
