  ...
  computed: {
    ...
    selected: {
      get: function(el) {
        ...
        // console.log(this.prop.cDisplayWithCode)
        ...
        if (this.value == "" || this.value == null) {
          ...
          if (this.isCanChange) {
            if (typeof this.value == "object") {
              ...
              // console.log(idx);
              // var i = [...this.options[idx]];
              // var i = this.options[idx].slice();
              // var i = Array.from(this.options[idx]);
              // var i = new Array(this.options[idx]);
              // var i = [...new Set(this.options[idx])];
  ...
  methods: {
    ...
    getData(search, loading) {
      ...
      var param = {
        ...
        ParamView: this.prop.dataLookUp.ParamView,
        UserId: this.getDataUser().user_id,
        PortfolioCd: this.getDataUser().portfolio_cd,
        SortField: this.prop.dataLookUp.OrderBy,
