<template>
  <span>
    <b-row v-show="prop.cVisible">
      ...
      <b-col :md="prop.cType=='decimal'||prop.cType=='numeric'?3:''" v-show="inputStatus!=='view'">
        <b-form-input
      ...
      <b-col :md="prop.cType=='decimal'||prop.cType=='numeric'?3:''" v-show="inputStatus=='view'" :style="style">
        <!-- <label class="lbl-value-view-form">{{prop.cType=='decimal'?isCurrency(value):value}}</label> -->
      </b-col>
      <b-col md="1"></b-col>
    </b-row>
  </span>
