            ...
            <div class="card__title">
              <b-row>
                <b-col style="max-width: max-content !important">
                  <span>User Management Access Button</span>
                </b-col>
...
export default {
  ...
  mounted() {
    ...
    // this.propList.initialWhere = "ss_portfolio_id='" + this.paramFromList.ss_portfolio_id + "' AND ss_group_id='" + this.paramFromList.ButtonAccess.ss_group_id + "' AND menu_url='" + this.paramFromList.ButtonAccess.menu_url + "'"
