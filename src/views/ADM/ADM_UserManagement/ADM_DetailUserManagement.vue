            ...
            <div class="card__title">
              <b-row>
                <b-col style="max-width: max-content !important">
                  <span>Detail User Management</span>
                </b-col>
...
export default {
  ...
  methods: {
    ...
    doButtonAccess(menu) {
      ...
      this.$router.push({ name: "ADM_UserManagementButtonAccess" });
    },
    showAccessDashboard(data) {
      ...
      // param.isEdit = true;
      // this.$store.commit("setParamPage", param);
      // this.$router.push({ name: "ADM_UserManagementDashboard" });
    },
    ...
    M_GetDashboard() {
      let param = {
        option_function_cd: "GetMenuDashboardUser",
        module_cd: "SS",
        user_id: this.paramFromList.user_id && this.paramFromList.user_id !== "" ? this.paramFromList.user_id : "NULL",
