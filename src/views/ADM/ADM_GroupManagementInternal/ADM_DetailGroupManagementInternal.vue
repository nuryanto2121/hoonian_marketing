            ...
            <div class="card__body">
              ...
              >
                ...
                <b-row>
                  ...
                  <b-col md="7">
                    {{M_GroupManagement.group_access == 'I' ? 'Internal' : 'Eksternal'}}
                  </b-col>
                </b-row>
...
export default {
  ...
  methods: {
    ...
    doButtonAccess(menu) {
      ...
      this.$router.push({ name: "ADM_GroupManagementButtonAccessInternal" });
    },
      ...
      var param = {
        ...
        group_id:
          this.paramFromList.row_id && this.paramFromList.row_id !== ""
            ...
            : "NULL",
        group_access: this.paramFromList2.group_access,
      };
    ...
    showAccessDashboard(data) {
      ...
      // param.isEdit = true;
      // this.$store.commit("setParamPage", param);
      // this.$router.push({ name: "ADM_GroupManagementDashboardInternal" });
    },
    init() {
      this.M_ClearForm();
      this.M_GetMenu();
