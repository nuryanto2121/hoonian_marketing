            ...
            <div class="card__title">
              <b-row>
                <b-col style="max-width: max-content !important;">
                  <span>User Group Internal Access Dashboard</span>
                </b-col>
              ...
              <b-row>
                <b-col>
                  <ACCFormList
                    ...
                    ref="ref_GroupManagementDashboard"
                  >
...
export default {
  ...
  methods: {
    ...
    M_Save() {
      let items = this.$refs.ref_GroupManagementDashboard.items;
      var param_Delete = {
          _Method_: "DELETE",
          _LineNo_: 2,
          ss_portfolio_id: this.paramFromList2.DetailList.row_id,
          ss_group_id: this.paramFromList.ss_group_id,
      ...
      for (let i = 0; i < items.length; i++) {
        if (items[i].is_access == true) {
          param_Save.push({
            ...
            _LineNo_: 2,
            ss_portfolio_id: this.paramFromList2.DetailList.row_id,
            ss_group_id: this.paramFromList.Dashboard.ss_group_id,
  ...
  mounted() {
    ...
    //   "menu_url='" +
    //   this.paramFromList.Dashboard.menu_url +
    //   "' AND ss_module_id=" +
    //   this.paramFromList.Dashboard.ss_module_id;
    this.propList.ParamView =
      "'" +
      this.paramFromList2.DetailList.row_id +
      "','" +
      this.paramFromList.ss_group_id +
      "','" +
      this.paramFromList.Dashboard.menu_url +
      "'";
    this.$refs.ref_GroupManagementDashboard.doGetList("");
  },
};
</script>
