            ...
            <div class="card__title">
              <b-row>
                <b-col style="max-width: max-content !important;">
                  <span>User Management Internal Access Dashboard</span>
                </b-col>
...
export default {
  ...
  mounted() {
    ...
    this.propList.ParamView = "'" + this.paramFromList.portfolio_id + "','" + this.paramFromList.Dashboard.user_id + "','" + this.paramFromList.Dashboard.menu_url + "'"
