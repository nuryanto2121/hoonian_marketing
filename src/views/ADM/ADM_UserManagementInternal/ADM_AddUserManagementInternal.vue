        ...
        <b-col md="12">
          <div class="card" style="font-size: 12px !important">
            <div class="card__title">
              <b-row>
                <b-col style="max-width: max-content !important">
                  <span>User Management Internal</span>
                </b-col>
            ...
            <div class="card__body">
              <b-form
                :data-vv-scope="'ADM_AddUserManagementInternal'"
                :data-vv-value-path="'ADM_AddUserManagementInternal'"
              >
                <b-row>
                  <b-col md="2">
                    <div>
                      <img
                        id="logo"
                        :src="M_UserManagement.file_show"
                        alt
                        width="100%"
                      />
                    </div>
                  ...
                  <b-col md="10">
                    <b-row>
                      <b-col sm="3">
                        <span>
                          <label>Mark user as INACTIVE</label>
                        </span>
                      </b-col>
                      <b-col sm="3" style="text-align: right;">
                        <b-form-checkbox
                          v-model="M_UserManagement.is_inactive"
                          name="check-button"
                          switch
                          size="lg"
                          :value="'Y'"
                    ...
                    <b-row>
                      <b-col md="2" class="col-p-1">
                        ...
                        <ACCDropDown
                          ...
                          :prop="PI_phone_no_1"
                          v-model="M_UserManagement.phone_no_1"
                          :label="M_UserManagement.phone_no_1Label"
                          ref="ref_phone_no_1"
                        />
                      </b-col>
                      <b-col md="4" class="col-p-3">
                        ...
                        <ACCTextBox
                          :prop="PI_phone_no_2"
                          v-model="M_UserManagement.phone_no_2"
                          ref="ref_phone_no_2"
                        />
                      </b-col>
                    </b-row>
                    ...
                    <b-row>
                      <b-col md="6">
                        <span>
                          <label>
                            <span style="color: red">*</span> Default Portfolio
                          </label>
                        </span>
                        <ACCDropDown
                          @change="OnPortfolioChange"
                          :prop="PI_portfolio"
                          v-model="M_UserManagement.portfolio"
                          :label="M_UserManagement.portfolioLabel"
                          ref="ref_portfolio"
                        />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col md="6">
                        ...
                        <ACCTextBox
                          :prop="PI_job_title"
                          v-model="M_UserManagement.job_title"
                          ref="ref_job_title"
                        />
                      </b-col>
                    </b-row>
...
export default {
  data() {
    return {
      ...
      PI_user_id: {
        ...
        cType: "text",
        cProtect: false,
        cParentForm: "ADM_AddUserManagementInternal",
        cDecimal: 2,
  ...
  methods: {
    Onphone_no_1Change(data) {
      this.$nextTick(() => {
        this.M_UserManagement.phone_no_1 = data.id;
        this.M_UserManagement.phone_no_1Label = data.id;
      });
    },
    onlogoChange(data) {
    ...
    OnroleChange(data) {
      this.$nextTick(() => {
        this.M_UserManagement.role = data.id;
        this.M_UserManagement.roleLabel = data.label;
        this.M_UserManagement.portfolio = '';
        this.M_UserManagement.portfolioLabel = '';

        this.PI_portfolio.dataLookUp.InitialWhere = 'ss_group_id=' + data.id;
      });
    },
    OnPortfolioChange(data) {
      this.$nextTick(() => {
        this.M_UserManagement.portfolio = data.id;
        this.M_UserManagement.portfolioLabel = data.label;
      });
    },
    doSave() {
      this.$validator._base
        .validateAll("ADM_AddUserManagementInternal")
        .then((result) => {
          if (!result) return;
          this.alertConfirmation("Are You Sure Want To Save This Data ?").then(
            (ress) => {
              if (ress.value) {
                this.$validator.errors.clear("ADM_AddUserManagementInternal");
    ...
    M_Save() {
      var param = {
        ss_portfolio_id: this.M_UserManagement.portfolio,
        ss_subportfolio_id: this.M_UserManagement.portfolio,
        ...
        hand_phone:
          this.M_UserManagement.phone_no_1 +
          "-" +
          this.M_UserManagement.phone_no_2,
        ...
        job_title: this.M_UserManagement.job_title,
        is_inactive: this.M_UserManagement.is_inactive,
    ...
    GetDataBy() {
      ...
      this.getJSON(this.getUrlAPIUser(this.paramFromList.row_id), param).then(
        (response) => {
          ...
          let phone_no =
            data.hand_phone && data.hand_phone !== ""
              ? data.hand_phone.split("-")
              : "";
          ...
          this.M_UserManagement = {
            ...
            password: "",
            confirm_password: "",
            role: parseInt(data.ss_group_id),
            ...
            portfolioLabel: data.portfolio_name,
          };

          if (this.inputStatus == "edit") {
            this.PI_portfolio.dataLookUp.InitialWhere = "user_id='" + data.user_id + "'";
          } else {
            this.PI_portfolio.dataLookUp.InitialWhere = 'ss_group_id=' + parseInt(data.ss_group_id);
          }
        }
      );
    },
  ...
  mounted() {
    this.M_ClearForm();
    if (this.inputStatus == "edit") {
      this.PI_portfolio.dataLookUp.LookUpCd = 'GetPorfolioUserEdit'
      this.GetDataBy();
    }
  },
};
