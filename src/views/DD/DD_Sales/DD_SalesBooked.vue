                  ...
                  <div class="card">
                    ...
                    <b-row class="title-primary">
                        <b-col style="max-width: max-content !important;">
                          <span style="font-size: 18px; color: #4a93b3;">Booked By Project</span>
                        </b-col>
                      ...
                      >
                        ...
                        <template slot="ToolbarTable">
                          ...
                          <b-col md="1" lg="1" xl="1" align-self="center" class="font-poppins noPadding" style="margin-right: 10px;">
                            <div align-self="center" style="--bgcolor: rgb(255 0 69);" class="badge-header-list">
                          ...
                          <b-col md="1" lg="1" xl="1" align-self="center" class="font-poppins noPadding" style="margin-right: 10px;">
                            <div align-self="center" style="--bgcolor: rgb(255 199 0);" class="badge-header-list">
                              <span style="margin: auto; font-size: 14px;">
                                {{data.total_unit}}
                              </span>
                            </div>
...
export default {
  ...
  methods: {
    ...
    getProject() {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/sales/header/booked', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelProject.push({
            ...data[i],
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/sales/grid/booked",
    ...
    renderList(id = -1) {
      if (id < 0) {
        for (let i = 0; i < this.ModelProject.length; i++) {
          // console.log('ref_sales_booked_'+i, this.$refs['ref_sales_booked_'+i])
          this.$refs['ref_sales_booked_'+i][0].doGetList("");
        }
      }
      else {
        ...
        this.$refs['ref_sales_booked_'+id][0].doGetList("");
      }
    }
  },
  mounted() {
