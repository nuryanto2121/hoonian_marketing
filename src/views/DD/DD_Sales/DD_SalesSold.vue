                  ...
                  <div class="card">
                    ...
                    <b-row class="title-primary">
                        <b-col style="max-width: max-content !important;">
                          <span style="font-size: 18px; color: #4a93b3;">Sold By Project</span>
                        </b-col>
                  ...
                  <b-col lg="12" xl="12">
                      ...
                      >
                        <template slot="TitleTable">
                          <b-col lg="6" xl="6" style="font-size: 16px; color: #4a93b3;">
                            {{data.project_name}}
                          </b-col>
                        </template>
...
export default {
  ...
  methods: {
    ...
    getProject() {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/sales/header/sold', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelProject.push({
            ...data[i],
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/sales/grid/sold",
    ...
    renderList(id = -1) {
      if (id < 0) {
        ...
        this.$refs['ref_sales_sold_'+id][0].doGetList("");
      }
    }
  },
  mounted() {
