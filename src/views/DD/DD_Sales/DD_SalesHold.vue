                  ...
                  <div class="card">
                    ...
                    <b-row class="title-primary">
                        <b-col style="max-width: max-content !important;">
                          <span style="font-size: 18px; color: #4a93b3;">Hold By Project</span>
                        </b-col>
                  ...
                  <b-col lg="12" xl="12">
                      ...
                      >
                        <template slot="TitleTable">
                          <b-col lg="6" xl="6" style="padding-left: unset !important;" class="title-list-primary">
                            {{data.project_name}}
                          </b-col>
                        </template>
                        <template slot="ToolbarTable">
                          ...
                          <b-col md="1" lg="1" xl="1" align-self="center" class="font-poppins noPadding" style="margin-right: 10px;">
                            <div align-self="center" style="--bgcolor: rgb(189 189 189);" class="badge-header-list">
...
export default {
  ...
  methods: {
    ...
    getProject() {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/sales/header/hold', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelProject.push({
            ...data[i],
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/sales/grid/hold",
    ...
    renderList(id = -1) {
      if (id < 0) {
        ...
        this.$refs['ref_sales_hold_'+id][0].doGetList("");
      }
    }
  },
  mounted() {
