                  ...
                  <div class="card">
                    ...
                    <b-row class="title-primary">
                        <b-col style="max-width: max-content !important;">
                          <span style="font-size: 18px; color: #4a93b3;">Unit Available By Project</span>
                        </b-col>
              ...
              <b-row v-bind:key="index">
                  <b-col lg="12" xl="12">
                      <HOOList
                        ...
                        :ref="'ref_sales_available_'+index"
...
export default {
  ...
  methods: {
    ...
    getProject() {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/sales/header/available', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelProject.push({
            ...data[i],
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/sales/grid/available",
    ...
    renderList(id = -1) {
      if (id < 0) {
        for (let i = 0; i < this.ModelProject.length; i++) {
          // console.log('ref_sales_available_'+i, this.$refs['ref_sales_available_'+i])
          this.ModelProject[i].propList.ParamWhere = this.search;
          this.ModelProject[i].propList.param.search = this.search;
          this.$refs['ref_sales_available_'+i][0].doGetList("");
        }
      }
      else {
        ...
        this.$refs['ref_sales_available_'+id][0].doGetList("");
      }
    }
  },
  mounted() {
