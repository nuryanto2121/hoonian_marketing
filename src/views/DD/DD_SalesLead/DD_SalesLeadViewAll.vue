              ...
              <b-col lg="12" xl="12">
                ...
                >
                  <template slot="TitleTable">
                    <b-col lg="2" xl="2" style="padding-left: unset !important;" class="title-list-primary text-single">
                      {{data.project_name}}
                    </b-col>
                  </template>
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/header/sales-lead', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelSalesLead.push({
            ...data[i],
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/grid/sales-lead",
