...
export default {
  ...
  methods: {
    ...
    getHeader() {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/reservation/header/referral-sales', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelReservation.push({
            ...data[i],
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/reservation/grid/referral-sales",
