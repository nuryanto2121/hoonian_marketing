...
export default {
  ...
  methods: {
    ...
    getHeader() {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/reservation/header/marked-book', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelReservation.push({
            ...
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/reservation/grid/marked-book",
