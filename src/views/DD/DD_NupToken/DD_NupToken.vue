                  ...
                  <div class="card">
                    ...
                    <b-row class="title-primary">
                        <b-col style="max-width: max-content !important;">
                            <span style="font-size: 18px; color: #4a93b3;">NUP and Token Detail</span>
                        </b-col>
  ...
  methods: {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/header/nup-token', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelProject.push({
            ...data[i],
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/grid/nup-token",
    ...
    renderList(id = -1) {
      if (id < 0) {
        ...
        this.$refs['ref_nup_token_'+id][0].doGetList("");
      }
    }
  },
  mounted() {
