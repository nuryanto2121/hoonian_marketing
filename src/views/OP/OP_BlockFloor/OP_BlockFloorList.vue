...
export default {
  data() {
    return {
      propList: {
        url: '/api/hoonian-website/view-block-floor-list',
        initialWhere: '',
        SortField: '',
        SortBy: '',
        ParamWhere: '',
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      param.ForBlockFloor = record;
      param.ForBlockFloor.isEdit = true;
      param.ForBlockFloor.isView = true;
  ...
  mounted() {
    // this.propList.initialWhere = this.paramFromList ? this.paramFromList.ForBlockFloor.tower_cluster_id : '';
