        ...
        <b-col lg="12" xl="12">
            <div class="card">
                ...
                <b-row class="title-primary">
                    ...
                    <span style="font-size: 18px; color: #4a93b3;">Open Agent Booking</span>
                    </b-col>
                            ...
                            <b-row style="margin-top: 20px;" class="poppins">
                                ...
                                <b-col lg="7" xl="7">
                                    <b-row>
                                        ...
                                        <b-col lg="6" xl="6" style="margin-right: 10px; text-align: center;" class="row-bordered">
                                            <span class="lbl-view poppins">Marketing Agent</span>
                                            <hr>
                                            <span style="font-size: 15px;" class="lbl-bold poppins">{{Model.marketing_name}}</span>
                                        </b-col>
                                        <b-col style="text-align: center;" class="row-bordered">
                                            <span class="lbl-view poppins">Total Blocked</span>
                                            <hr>
                                            <span style="font-size: 15px;" class="lbl-bold poppins">{{Model.total_blocked}} X</span>
                                        </b-col>
                                    </b-row>
                                    <b-row>
...
export default {
  ...
  methods: {
    ...
    GetDataBy() {
      ...
      this.postJSON(
        this.urlHoonian + "/api/hoonian-website/dashboard/operation-detail/blocking/marketing/detail",
        param
      ).then((response) => {
    ...
    M_Update() {
      ...
      this.postJSON(
        this.urlHoonian + "/api/hoonian-website/dashboard/operation-detail/blocking/marketing/action",
        param
      ).then((response) => {
        if (response == null) return;
        this.doBack();
