    ...
    <div class="dashboard-page-chart__body">
      <b-row class="dashboardBody">
        <b-col md="12">
          <HOOList
            :prop="propList"
            :title="'Offline Sales by Developer'"
            ...
            ref="ref_list"
            urlAdd="OP_OfflineSalesByDeveloperForm"
          ...
          >
            <template slot="sales_date" slot-scope="data">
              <span>
                {{ momentUnix(data.item.sales_date, "YYYY-MM-DD HH:mm") }}
              </span>
            </template>
          </HOOList>
        </b-col>
...
export default {
  data() {
    return {
      propList: {
        url: "/api/hoonian-website/offline-sales-by-developer-list",
        initialWhere: "",
        SortField: "",
        SortBy: "",
        ParamWhere: "",
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      this.$router.push({ name: "OP_OfflineSalesByDeveloperForm" });
    },
