...
export default {
  data() {
    return {
      propList: {
        url: '/api/hoonian-website/view-skip-no-list',
        initialWhere: '',
        SortField: '',
        SortBy: '',
        ParamWhere: '',
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      param.ForSkipNo = record;
      param.ForSkipNo.isEdit = false;
      param.ForSkipNo.isView = true;
  ...
  mounted() {
    this.propList.initialWhere = this.paramFromList ? this.paramFromList.ForSkipNo.nup_id : '';
