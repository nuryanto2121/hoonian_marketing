  ...
  methods: {
    ...
    renderList(id = -1) {
      if (id < 0) {
        ...
        this.$refs['ref_booked_list_'+id][0].doGetList("");
      }
    }
  },
  mounted() {
