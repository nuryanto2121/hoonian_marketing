                  ...
                  <div class="card">
                    ...
                    <b-row class="title-primary">
                        <b-col style="max-width: max-content !important;">
                            <span style="font-size: 18px; color: #4a93b3;">Offline Sales Detail</span>
                        </b-col>
                      ...
                      >
                        ...
                        <template slot="ToolbarTable">
                          <b-col align-self="center" class="col-right font-poppins lbl-header-list">
                            <b>
                              Total Offline Sales Units
                            </b>
                          </b-col>
                          <b-col md="1" lg="1" xl="1" align-self="center" class="font-poppins noPadding">
                            <div align-self="center" style="--bgcolor: rgb(138 111 223);" class="badge-header-list">
...
export default {
  ...
  methods: {
    ...
    rowClicked(ev, id) {
      ...
      this.$router.push({ name: "OP_OfflineSalesForm" });
    },
    doDeleteClick(ev, id) {
      console.log(ev, id)
    },
    ...
    getProject() {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/dashboard/management-detail/reservation/header/offline-sales', param).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.ModelProject.push({
            ...data[i],
            propList: {
              url: "/api/hoonian-website/dashboard/management-detail/reservation/grid/offline-sales",
    ...
    renderList(id = -1) {
      if (id < 0) {
        ...
        this.$refs['ref_offline_list_'+id][0].doGetList("");
      }
    }
  },
  mounted() {
