...
export default {
  data() {
    return {
      propList: {
        url: '/api/hoonian-website/view-payment-scheme-list',
        initialWhere: '',
        SortField: '',
        SortBy: '',
        ParamWhere: '',
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      param.ForPaymentScheme = record;
      param.ForPaymentScheme.isEdit = true;
      param.ForPaymentScheme.isView = true;
  ...
  mounted() {
    // this.propList.initialWhere = this.paramFromList ? this.paramFromList.project_master_id : '';
