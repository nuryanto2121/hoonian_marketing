...
export default {
  data() {
    return {
      propList: {
        url: '/api/hoonian-website/view-unit-master-list',
        initialWhere: '',
        SortField: '',
        SortBy: '',
        ParamWhere: '',
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      param.ForUnitMaster = record;
      param.ForUnitMaster.isEdit = true;
      param.ForUnitMaster.isView = true;
  ...
  mounted() {
    // this.propList.initialWhere = this.paramFromList ? this.paramFromList.ForUnitMaster.tower_cluster_id : '';
