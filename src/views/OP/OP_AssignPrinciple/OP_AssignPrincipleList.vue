...
export default {
  data() {
    return {
      propList: {
        url: '/api/hoonian-website/view-assign-principle-list',
        initialWhere: '',
        SortField: '',
        SortBy: '',
        ParamWhere: '',
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      param.ForAssignPrinciple = record;
      param.ForAssignPrinciple.isEdit = false;
      param.ForAssignPrinciple.isView = true;
      this.$store.commit("setParamPage", param);
      this.$router.push({ name: "OP_AssignPrincipleView" });
    },
  ...
  mounted() {
    this.propList.initialWhere = this.paramFromList ? this.paramFromList.id : '';
