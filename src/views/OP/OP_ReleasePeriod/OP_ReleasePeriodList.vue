...
export default {
  data() {
    return {
      propList: {
        url: '/api/hoonian-website/view-release-period-list',
        initialWhere: '',
        SortField: '',
        SortBy: '',
        ParamWhere: '',
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      param.ForReleasePeriod = record;
      param.ForReleasePeriod.isEdit = false;
      param.ForReleasePeriod.isView = true;
      this.$store.commit("setParamPage", param);
      this.$router.push({ name: "OP_ReleasePeriodView" });
    },
