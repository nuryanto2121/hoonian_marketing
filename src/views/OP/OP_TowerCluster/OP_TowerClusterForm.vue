                ...
                <b-row>
                  ...
                  <b-col md="10">
                    <b-row>
                      <b-col md="6">
                        <span>
                          <label><span style="color:red;">* </span>Tower Cluster Name</label>
                        </span>
                        <ACCTextBox
...
export default {
  ...
  methods: {
    ...
    M_Save() {
      ...
      this.postJSON(this.urlHoonian + '/api/hoonian-website/view-tower-cluster-addedit', this.Model).then((response) => {
