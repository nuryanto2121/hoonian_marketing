      ...
      <b-row class="dashboardBody">
        <b-col md="12">
          <HOOList
            ...
            ref="ref_list"
            urlAdd="SS_MasterIncomeRangeForm"
...
export default {
  data() {
    return {
      propList: {
        url: "/api/hoonian-website/referral-income-range-master-list",
        initialWhere: "",
        SortField: "",
        SortBy: "",
        ParamWhere: "",
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      this.$router.push({ name: "SS_MasterIncomeRangeForm" });
    },
