...
export default {
  data() {
    return {
      propList: {
        ...
        TabIndex: 1,
        OrderBy:
          "option_url , menu_url , sequence_form , display_form , order_button",
        SourceField: "",
        ParamView: "",
      },
    };
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      this.$router.push({ name: "SS_ButtonAccessForm" });
    },
    ...
    M_Delete(record, index) {
      ...
      this.deleteJSON(this.getUrlCRUD(), param).then((response) => {
        ...
        this.$refs.ref_Button.doGetList("");
      });
    },
    rowLink(url) {},
    M_PageSize() {},
