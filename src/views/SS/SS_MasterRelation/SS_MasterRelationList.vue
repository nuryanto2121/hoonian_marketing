    ...
    <div class="dashboard-page-chart__body">
      <b-row class="dashboardBody">
        <b-col md="12">
          <HOOList
            :prop="propList"
            :title="'Referral Relation Master'"
...
export default {
  data() {
    return {
      propList: {
        url: '/api/hoonian-website/referral-relation-master-list',
        initialWhere: '',
        SortField: '',
        SortBy: '',
        ParamWhere: '',
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      this.$router.push({ name: "SS_MasterRelationForm" });
    },
