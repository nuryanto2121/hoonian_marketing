      ...
      <b-row class="dashboardBody">
        <b-col md="12">
          <HOOList
            ...
            ref="ref_list"
            urlAdd="SS_MarketingAgentGroupForm"
...
export default {
  data() {
    return {
      propList: {
        url: "/api/hoonian-website/marketing-agent-group-list",
        initialWhere: "",
        SortField: "",
        SortBy: "",
        ParamWhere: "",
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      this.$router.push({ name: "SS_MarketingAgentGroupForm" });
    },
