    ...
    <div class="dashboard-page-chart__body">
      <b-row class="dashboardBody">
        <b-col md="12">
          <HOOList
            :prop="propList"
            :title="'Master Mobile Menu Category'"
            ...
            ref="ref_list"
            urlAdd="SS_MobileMenuCategoryForm"
...
export default {
  data() {
    return {
      propList: {
        url: "/api/hoonian-website/menu-category-master-list",
        initialWhere: "",
        SortField: "",
        SortBy: "",
        ParamWhere: "",
  ...
  methods: {
    ...
    doViewClick(record, index) {
      ...
      this.$router.push({ name: "SS_MobileMenuCategoryForm" });
    },
