        ...
        <b-col md="12">
          ...
          >
            <template slot="start_datetime" slot-scope="data">
              <span>
                {{ momentUnix(data.item.start_datetime, "YYYY-MM-DD HH:mm") }}
              </span>
            </template>
            <template slot="end_datetime" slot-scope="data">
              <span>
                {{ momentUnix(data.item.end_datetime, "YYYY-MM-DD HH:mm") }}
              </span>
            </template>
          </HOOList>
        </b-col>
...
export default {
  data() {
    return {
      propList: {
        url: "/api/hoonian-website/promotion-master-list",
        initialWhere: "",
        SortField: "",
        SortBy: "",
        ParamWhere: "",
