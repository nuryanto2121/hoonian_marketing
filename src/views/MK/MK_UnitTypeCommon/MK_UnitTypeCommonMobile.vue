...
export default {
  ...
  data() {
    return {
      ...
      virtualAccount: {},
      propList: {
        url: "/api/marketing-website/common/project/unit-type/unit-list",
        initialWhere: "",
        SortField: "",
        SortBy: "desc",
        ParamWhere: "",
  ...
  methods: {
    ...
    openFloorPlan() {
      ...
      this.$router.push({ name: "MK_FloorPlanCommon" });
    },
    openLayout() {
    ...
    getUnitTypeDetail() {
      ...
      this.postJSON(this.urlHoonian + '/api/marketing-website/common/project/unit-type/detail', param, true, false).then((response) => {
    ...
    getOtherSuggestion() {
      ...
      this.postJSON(
        this.urlHoonian + "/api/marketing-website/common/project/unit-type/suggestion", param, true, false).then((response) => {
        if (response == null) return;
