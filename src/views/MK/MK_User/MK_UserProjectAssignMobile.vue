            ...
            <b-col cols="12">
              <div class="card">
                  <div class="card__body">
                      <b-row>
                          <b-col cols="12" class="user-project-form">
                              <span>
              ...
              <b-row style="margin: 20px 0px 20px 0px;">
                  <template v-for="(project, index) of AllProject">
                      <b-col cols="12" class="user-project-card" v-bind:key="index" :style="'padding: 5px; ' + ((index+1)%3 == 0 ? 'margin: 0px 0px 10px 0px;' : 'margin: 0px 20px 10px 0px;')">
                          <b-row class="noPadding">
                              ...
                              <b-col cols="4" class="user-project-img-space">
