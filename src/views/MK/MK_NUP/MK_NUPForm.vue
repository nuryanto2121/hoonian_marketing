        ...
        <b-col lg="12" xl="12" style="background: white;">
          <b-form :data-vv-scope="'FormEntry'" :data-vv-value-path="'FormEntry'">
            <b-row style="margin-top: 10px; background: #F8F8F8; padding-top: 10px; padding-bottom: 10px;">
              <b-col md="2">
                <b-img id="name_card_show" :src="urlHoonian + paramFromList.icon_project" alt="" height="100" width="100" @error="onImageLoadFailure($event)" />
              </b-col>
            ...
            <b-row style="padding-top: 10px;">
              ...
              <b-col offset-md="1" md="3">
                ...
                <br />
                <span style="color: #4A93B3; text-shadow: 0.5px 0px;">
                  {{isCurrency(paramFromList.value, 2)}}
                </span>
              </b-col>
            </b-row>
            <b-row>
              ...
              <b-col offset-md="1" md="3">
                ...
                <br />
                <span style="color: #4A93B3; text-shadow: 0.5px 0px;">
                  {{isCurrency(paramFromList.total_nup * (Model.total_purchase? Model.total_purchase: 0), 2)}}
                </span>
              </b-col>
            </b-row>
            <b-row>
