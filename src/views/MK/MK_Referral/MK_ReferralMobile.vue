    ...
    <b-row class="dashboardBody">
            ...
            <b-col cols="12">
              <b-row style="overflow-x: auto; white-space: nowrap; display: block !important;">
                <template v-for="(data, index) in ModelProject">
                  <b-col cols="8" v-bind:key="index" style="background-color: #FFFF; margin: 5px; cursor: pointer; display: inline-block; float: none;" :class="'referral-card '+ (selectedProject == index ? 'activate' : '')" @click.prevent="onProjectChange(index)">
                    <b-row class="noPadding">
                      ...
                      <b-col class="noPadding" cols="8">
                        <div class="center" style="text-align: center; width: 100%;">
                          <span class="title-primary" style="font-weight: bold; font-size: 17px; color: #4f4f4f !important;"> Total Referral </span> <br>
                          <span class="title-primary" style="font-weight: bold; font-size: 17px;">{{data.total_referral}}</span>
                        </div>
                      </b-col>
          ...
          <b-col cols="12">
              ...
              >
                <template slot="TitleTable">
                  <b-col cols="12" style="padding-left: unset !important; font-size: 15px;" class="title-list-primary">
                    {{$t('referral_list')}}
                  </b-col>
                </template>
      ...
      <b-row style="margin-bottom: 20px;">
        <b-col style="text-align: center;">
          <ABSButton
                :text="$t('save')"
                classButton="btn btn--default referral-btnSave"
