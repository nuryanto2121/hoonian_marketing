                  ...
                  <b-col sm="6" :key="indexDetail">
                    <div class="card">
                      <div class="card__body" style="padding: unset !important;">
                        ...
                        <b-row style="padding: 0px 10px !important; padding-bottom: 10px; font-size: 14px;">
                          <b-col style="">
...
export default {
  ...
  methods: {
    ...
    getAllPromotion() {
      ...
      this.postJSON(this.urlHoonian + '/api/marketing-website/dashboard/all-promotion', param).then((response) => {
