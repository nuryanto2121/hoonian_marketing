            ...
            <b-col cols="12">
              <b-row style="overflow-x: auto; white-space: nowrap; display: block !important;">
                <template v-for="(data, index) in ModelProject">
                  <b-col cols="8" v-bind:key="index" style="background-color: #FFFF; margin: 5px; cursor: pointer; display: inline-block; float: none;" :class="'token-card '+ (selectedProject == index ? 'activate' : '')" @click.prevent="onProjectChange(index)">
