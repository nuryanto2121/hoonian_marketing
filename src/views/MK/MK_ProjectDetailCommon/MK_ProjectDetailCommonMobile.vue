  ...
  <div>
    <b-row class="dashboardBody">
      <b-col lg="12" xl="12" style="background: white;">
        ...
        <b-row>
          <b-col>
            <span style="word-spacing: 1px; color: #828282; font-size: 14px;">
              {{Model.data.address}}
            </span>
          </b-col>
        </b-row>
        ...
        <b-col cols="12" style="padding: unset !important; background: black; color: white; text-align: center;">
          <b-row style="margin-top: 10px; margin-left: 10px !important; margin-right: 10px !important;">
            <b-col>
              <div style="border: 1px solid #FFFFFF;
                ...
                <b-row style="cursor: pointer;" class="project-detail-info-card" @click="openBuildingPlan">
                  <b-col cols="2" align-self="center">
                    <b-img :src="require('@/assets/icon-svg/building_plan.svg')" alt="" class="project-detail-info-img" />
                  </b-col>
                  <b-col cols="9" align-self="center" style="padding: 5px !important;" class="project-detail-info-text">
                    {{ $t('building_plan') }}
                  </b-col>
                </b-row>
              </div>
          ...
          <b-row style="margin-top: 5px; margin-left: 10px !important; margin-right: 10px !important;">
            <b-col>
              <div style="border: 1px solid #FFFFFF;
                          box-sizing: border-box;">
                <b-row style="cursor: pointer;" class="project-detail-info-card" @click="open360VR">
                  <b-col cols="2" align-self="center">
                    <b-img :src="require('@/assets/icon-svg/vr.svg')" alt="" class="project-detail-info-img" />
                  </b-col>
                  <b-col cols="9" align-self="center" style="padding: 5px !important;" class="project-detail-info-text">
                    360<sup>o</sup> {{ $t('vr') }}
                  </b-col>
          ...
          <b-row style="margin-top: 5px; margin-left: 10px !important; margin-right: 10px !important;">
            <b-col>
              <div style="border: 1px solid #FFFFFF;
                          box-sizing: border-box;">
                <b-row style="cursor: pointer;" class="project-detail-info-card" @click="openVideo">
                  <b-col cols="2" align-self="center">
                    <b-img :src="require('@/assets/icon-svg/video.svg')" alt="" class="project-detail-info-img" />
                  </b-col>
                  <b-col cols="9" align-self="center" style="padding: 5px !important;" class="project-detail-info-text">
                    {{ $t('video') }}
                  </b-col>
          ...
          <b-row style="margin-top: 5px; margin-left: 10px !important; margin-right: 10px !important;">
            <b-col>
              <div style="border: 1px solid #FFFFFF;
                          box-sizing: border-box;">
                <b-row style="cursor: pointer;" class="project-detail-info-card" @click="openBrochure">
                  <b-col cols="2" align-self="center">
                    <b-img :src="require('@/assets/icon-svg/e_brochure.svg')" alt="" class="project-detail-info-img" />
                  </b-col>
                  <b-col cols="9" align-self="center" style="padding: 5px !important;" class="project-detail-info-text">
                    {{ $t('e_brochure') }}
                  </b-col>
          ...
          <b-row style="margin-top: 5px; margin-left: 10px !important; margin-right: 10px !important;">
            <b-col>
              <div style="border: 1px solid #FFFFFF;
                          box-sizing: border-box;">
                <b-row style="cursor: pointer;" class="project-detail-info-card" @click="openMap">
                  <b-col cols="2" align-self="center">
                    <b-img :src="require('@/assets/icon-svg/map-pin-white.svg')" alt="" class="project-detail-info-img" />
                  </b-col>
                  <b-col cols="9" align-self="center" style="padding: 5px !important;" class="project-detail-info-text">
                    {{ $t('map') }}
                  </b-col>
          ...
          <b-row style="margin-top: 20px; margin-bottom: 20px;">
            <b-col cols="2" offset="2">
              <ShareNetwork
                ...
                hashtags="hoonian"
              >
                <b-img :src="require('@/assets/icon-svg/facebook_white.svg')" alt="" class="project-detail-info-sosmed" style=""/>
              </ShareNetwork>
            </b-col>
            <b-col cols="2">
              <ShareNetwork
                ...
                hashtags="hoonian"
              >
                <b-img :src="require('@/assets/icon-svg/twitter_white.svg')" alt="" class="project-detail-info-sosmed" style=""/>
              </ShareNetwork>
            </b-col>
            <b-col cols="2">
              <b-img :src="require('@/assets/icon-svg/whatsapp_white.svg')" alt="" class="project-detail-info-sosmed" style="cursor: pointer;" @click="doWhatsapp"/>
            </b-col>
            <b-col cols="2">
              <b-img :src="require('@/assets/icon-svg/email_white.svg')" alt="" class="project-detail-info-sosmed" style="cursor: pointer;" @click="doEmail"/>
            </b-col>
          </b-row>
        </b-col>
        </b-row>
        ...
        <b-col cols="12" style="margin-top: 20px;">
          <div style="overflow-x: auto; white-space: nowrap; display: block !important;">
            <template v-for="(data, index) in Model.facility_images">
              <b-img v-bind:key="index" :src="urlHoonian + data.thumbnail_image" alt="" style="height: 220px; cursor: pointer; max-width: 90%; margin-left: 5px;" fluid-grow @error="onImageLoadFailure($event)" @click="doViewDetail(data)" />
            </template>
          </div>
        </b-col>
        <b-col cols="12" style="margin-top: 20px;">
        ...
        <!-- hide -->
        <b-row v-if="false" style="margin-top: 10px; font-size: 13px;">
          ...
          <b-col md="12" style="padding-left: unset !important; padding-right: unset !important;">
            <b-row>
              <b-col style="border: solid 1px #dfe3f3; border-radius: 6px;">
                ...
                <div style="margin-top: 10px; padding-left: unset !important; padding: 15px;">
                  <div style="
                      width: 175px;
                      height: 175px;
      ...
      <ABSModalImage id="Modal_Image" ref="Modal_Image" size="md" />
        ...
        <b-row v-if="News.length > 0" style="padding-top: 20px; background: #F8F8F8;">
          ...
          <template v-for="(news, index) in News">
            ...
            <b-col cols="4" style="" @click="showWebsite(News[index])" class="news-img">
...
export default {
      ...
      availableUnitTypesHeader: [
        {
          ...
          thClass: "HeaderACCList2 S th-cus-left S poppins",
        },
        {
          key: "gross_area",
          label: "GROSS AREA",
        ...
        },
        {
          ...
          label: "",
          tdClass: "ContentACCList2 notranslate th-cus-left poppins",
          thClass: "HeaderACCList2 S th-cus-left poppins",
          isCustom: true,
        },
        {
          key: "total_bathroom",
        ...
        },
        {
          ...
          label: "DIRECTION",
          tdClass: "ContentACCList2 notranslate th-cus-left poppins",
          thClass: "HeaderACCList2 M th-cus-left poppins",
        },
        {
          key: "start_from",
          label: "START FROM",
          tdClass: "ContentACCList2 notranslate th-cus-left poppins",
          thClass: "HeaderACCList2 M th-cus-left M poppins",
        },
      ],
      Progress: [],
      ProgressDetail: {
  ...
  methods: {
    ...
    getProgressDetail(id) {
      ...
      this.postJSON(
          this.urlHoonian + "/api/marketing-website/common/project/progress/detail",
          param,
          false,
          false,
      ).then((response) => {
      ...
      this.postJSON(this.urlHoonian + '/api/marketing-website/common/project/available-unit-types-header', param, true, false).then((response) => {
        ...
        for (let i = 0; i < data.length; i++) {
          this.AvailableUnitTypes.push({
            ...data[i],
            propList: {
              url: "/api/marketing-website/common/project/available-unit-types-grid",
              initialWhere: "",
              SortField: "",
              SortBy: "desc",
              ParamWhere: "",
    ...
    getProgress() {
      ...
      this.postJSON(this.urlHoonian + '/api/marketing-website/common/project/progress', param, true, false).then((response) => {
        if (response == null) return;
    ...
    getPromotion() {
      ...
      this.postJSON(this.urlHoonian + '/api/marketing-website/common/project/promotion', param, true, false).then((response) => {
        if (response == null) return;
    ...
    getFinancialPartner() {
      ...
      this.postJSON(this.urlHoonian + '/api/marketing-website/common/project/financial-partners', param, true, false).then((response) => {
        if (response == null) return;
    ...
    getNews() {
      ...
      this.postJSON(this.urlHoonian + '/api/marketing-website/common/project/news', param, true, false).then((response) => {
        if (response == null) return;
