        ...
        <b-row>
            ...
            <div class="card">
                <div class="card__body poppins">
                    <b-row>
                        <b-col style="text-align: center; margin-bottom: 10px;">
                            <span style="font-size: 16px; font-weight: bold; letter-spacing: 3px;">
                                {{Model.project_name}}
                            </span>
                        </b-col>
                    </b-row>
                        ...
                        <b-col>
                            <template v-if="paramFromList.status == 'w'">
                                <template v-if="!paramFromList.inDays">
                                    ...
                                    <b-row>
                                        <b-col cols="12" style="text-align: center;" class="vlaunching-time-to-launch">
                                            <span class="vlaunching-time-to-launch-text">
                                              {{ $t('time_to_launching') }}
                                            </span>
                                        </b-col>
                        ...
                        <b-col cols="12" class="noPadding vlaunching-card">
                            ...
                            >
                                ...
                                <template slot="ToolbarTable">
                                    <b-col cols="6" align-self="center" style="text-align: end !important;">
                                        <ABSButton
                                            :text="$t('confirmation_s')"
                                            classButton="button button--hoonian"
                                            @click="doSave"
                                            :disabled="paramFromList.status !== 'i' || !(Model.active_nup && Model.active_nup !== '')"
                                            styleButton="background-color: #4a93b3 !important; color: #FFF !important; width: 150px; height: 35px; font-size: 14px !important;"
                                        />
                                    </b-col>
                                </template>
    ...
    return {
      ...
      UnitHeader: [
        ...
        },
        {
          ...
          tdClass: "ContentACCList2 S notranslate th-cus-center poppins",
          thClass: "HeaderACCList2 th-cus-center poppins",
        },
        {
          key: "floor",
        ...
        },
        {
          ...
          tdClass: "ContentACCList2 S notranslate th-cus-right poppins",
          thClass: "HeaderACCList2 th-cus-center poppins",
        },
        {
          key: "status",
