<template>
  <div class="abs-login">
    <div style="height: 100%; width: 100%; background-color: #FFFFFF"></div>
    <div style="height: 100%; width: 62%; background-color: #4a93b3; position: absolute; right: 0; border-bottom-left-radius: 400px"></div>
    <div class="box-forgot-baru">
      <b-form @submit.prevent="onSubmit">
        <b-row>
          <b-col style="text-align: center;">
            <label class="lbl-poppins" style="color: #4a93b3; font-weight: bold; font-size: 20px; text-shadow: 0px 0px;">Forgot Password</label>
          </b-col>
        </b-row>
        ...
        <b-row style="margin-top: 50px;">
          <b-col>
            <label class="lbl-poppins" style="color: #4a93b3; font-weight: bold; font-size: 15px;" v-if="statusForgot === null">Registered Email</label>
            <label class="lbl-poppins" style="color: #4a93b3; font-weight: bold; font-size: 15px;" v-else-if="statusForgot === 'T'">We send verification OTP to your email address to verify your account please input the OTP below</label>
            <label class="lbl-poppins" style="color: #4a93b3; font-weight: bold; font-size: 15px;" v-else-if="statusForgot === 'P'">Please input new password</label>
          </b-col>
        </b-row>
        <b-row>
          <b-col>
            <div class="form-label-group">
              <b-form-input
                ...
                id="inputOne"
                class="form-control input-field poppins"
        ...
        <b-row style="margin-top: 10px;">
          <b-col style="text-align: center;">
            <button
              class="btn btn-big btn-block poppins"
        ...
        <b-row>
          <b-col style="position: absolute; bottom: 40px; text-align: center; left: 0;">
            <!-- <div> -->
              <label
                class="lbl-poppins"
                @click="doBack"
                style="font-size:20px !important;color:hsl(240, 49%, 41%); cursor: pointer !important; color: rgb(74, 147, 179); font-weight: bold; text-shadow: 0px 0px;"
              >Back</label>
            <!-- </div> -->
          </b-col>
        </b-row>
    ...
    onSubmit() {
      if (this.statusForgot == null) {
        ...
        if ((this.fieldOne && this.fieldOne !== '') || (this.fieldTwo && this.fieldTwo !== '')) {
          ...
          this.alertInfo("Please Input Your Registered Email");
        }
