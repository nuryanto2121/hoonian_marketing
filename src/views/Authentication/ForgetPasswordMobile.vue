<template>
  <div class="abs-login">
    ...
    <div style="height: 100%; width: 63%; background-color: #4a93b3; position: absolute; right: 0; border-bottom-left-radius: 400px"></div>
    <div class="box-forgot-baru">
        <b-form @submit.prevent="onSubmit">
            <b-row>
            <b-col style="text-align: center;">
                <label class="lbl-poppins" style="color: #4a93b3; font-weight: bold; font-size: 18px; text-shadow: 0px 0px;">Forgot Password</label>
            </b-col>
            </b-row>
            ...
            <b-row>
            <b-col class="mbl-back">
                <!-- <div> -->
                <label
                    class="lbl-poppins"
                    @click="doBack"
                    style="font-size: 18px !important; color :hsl(240, 49%, 41%); cursor: pointer !important; color: rgb(74, 147, 179); font-weight: bold; text-shadow: 0px 0px;"
                >Back</label>
                <!-- </div> -->
            </b-col>
            </b-row>
